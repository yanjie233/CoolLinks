...
export const metadata: Metadata = {
  title: "Login | CoolLinks",
  description: "Login to your CoolLinks account",
}
      ...
      <div className="relative hidden h-full flex-col bg-muted p-10 text-white lg:flex dark:border-r">
        ...
        <div className="relative z-20 mt-auto">
          <blockquote className="space-y-2">
            <p className="text-lg">
              "CoolLinks has revolutionized how we share content with our audience. The analytics and security features
              are unmatched."
            </p>
